...
number_of_habitat = int(input("Which habitat # do you need? "))
while True:
    print(habitats[number_of_habitat])
    print("Maybe it's time to change the channel?")
    number_of_habitat = input("Which habitat # do you need? ")
    if number_of_habitat == str("exit"):
        break
    else:
        number_of_habitat = int(number_of_habitat)
print("See you!")